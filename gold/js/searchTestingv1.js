...
function getSearch() {
	...
	if (localStorage.length === 0) {
		...
		var makeDiv = getID("searchResults");
		...
		getID("searchResults").style.display = "block";
			...
			for (var i = 0, len = localStorage.length; i < len; i++) {
				...
				for (var a in obj) {
					var makeSubLi = document.createElement("ui");
...
// function results(){
	// var getResults = getID('searchResults');
	// resultTxt.innerHTML = "";
	// getResults.style.border = "1px white";
// 	
	// var resultsArray = [];
	// if(getResults === ""){
		// var resultsError = "Nothing found";
	// }
// }
